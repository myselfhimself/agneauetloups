...
{
    GtkWidget *Question;
    /** - cr�tion de la fen�re de dialogue\n
    */
    ...
    /** - affichage de la fen�re de dialogue\n
    * -# si r�onse positive : appelle le gtk_main_quit()\n
    * -# si r�onse n�ative : d�ruit seulement le widget\n
    */
